...
PATH2LIB="/home/riyaag/SuperblockFormationProject/build/SuperblockFormationPass/SuperblockFormationPass.so"        # Specify your build directory in the project

# ACTION NEEDED: Choose the correct pass when running.
PASS=superblock_pass                   # Choose either -fplicm-correctness ...
